...
Aperant is currently licensed under AGPL-3.0. The CLA ensures the project has proper licensing flexibility should we introduce additional licensing options (such as commercial/enterprise licenses) in the future.
...
Aperant automatically downloads prebuilt binaries for Windows. If prebuilts aren't available for your Electron version yet, you'll need Visual Studio Build Tools:
...
When contributing to Aperant, you'll typically fork the repository first. Proper fork configuration is essential to avoid sync issues.
...
Aperant is a single Electron desktop application in `apps/desktop/`.
...
Thank you for contributing to Aperant!

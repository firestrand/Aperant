# Aperant Desktop Usage

Aperant is a desktop application. There is no standalone CLI workflow; all product functionality is accessed through the Electron desktop UI.

## Getting Started

1. Download the latest release for your platform from the [Aperant releases page](https://github.com/firestrand/Aperant/releases)

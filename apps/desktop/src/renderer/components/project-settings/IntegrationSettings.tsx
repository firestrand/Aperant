            ...
            {envConfig.linearEnabled && (
              <>
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {t('projectSections.linear.getApiKeyFrom')}{' '}
                    <a
                          ...
                          {isCheckingLinear ? t('projectSections.linear.checking') :
                            linearConnectionStatus?.connected
                              ? linearConnectionStatus.teamName
                                ? t('projectSections.linear.connectedToTeam', { teamName: linearConnectionStatus.teamName })
                  ...
                  <div className="rounded-lg border border-info/30 bg-info/5 p-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          {t('projectSections.linear.importExistingTasksDescription')}
                        </p>
                        <Button
                          size="sm"
                          variant="outline"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label className="text-sm font-medium text-foreground">{t('projectSections.linear.teamIdOptional')}</Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm font-medium text-foreground">{t('projectSections.linear.projectIdOptional')}</Label>
                    <Input
            ...
            {envConfig.githubEnabled && (
              <>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {isCheckingGitHub ? t('projectSections.github.checking') :
                            gitHubConnectionStatus?.connected
                              ? t('projectSections.github.connectedToRepo', { repo: gitHubConnectionStatus.repoFullName })
                ...
                <div className="space-y-2">
                  ...
                  {settings.mainBranch && (
                    <p className="text-xs text-muted-foreground">
                      {t('projectSections.github.tasksCreatedOnBranchesLike')} <code className="px-1 bg-muted rounded">auto-claude/task-name</code> {t('projectSections.github.fromBranch')} <code className="px-1 bg-muted rounded">{settings.mainBranch}</code>
                    </p>
                  )}
                </div>
              </>
